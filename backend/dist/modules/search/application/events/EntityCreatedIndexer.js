...
exports.EntityCreatedIndexer = void 0;
...
let EntityCreatedIndexer = class EntityCreatedIndexer {
    searchRepository;
    constructor(searchRepository) {
        this.searchRepository = searchRepository;
    }
    async handle(event) {
        const document = new SearchDocument_1.SearchDocument(new UniqueEntityId_1.UniqueEntityId(), 'entity', event.entity.id, {
...
exports.EntityCreatedIndexer = EntityCreatedIndexer;
exports.EntityCreatedIndexer = EntityCreatedIndexer = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)('ISearchRepository')),
    __metadata("design:paramtypes", [Object])
], EntityCreatedIndexer);
//# sourceMappingURL=EntityCreatedIndexer.js.map