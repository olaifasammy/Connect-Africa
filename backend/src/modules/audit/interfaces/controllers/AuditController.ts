...
@provide(AuditController, true)
@injectable()
export class AuditController {
  constructor(
    private readonly recordAuditCommandHandler: RecordAuditCommandHandler,
    private readonly searchAuditQueryHandler: SearchAuditQueryHandler
  ) {}
