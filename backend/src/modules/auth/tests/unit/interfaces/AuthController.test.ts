...
describe('AuthController', () => {
  ...
  let mockLogoutHandler: any;
  let mockRefreshHandler: any;
  let mockRegisterUserHandler: any;
  let mockResetPasswordHandler: any;
  let mockVerifyEmailHandler: any;
  let mockUpdateProfileHandler: any;
  let mockBanUserHandler: any;
